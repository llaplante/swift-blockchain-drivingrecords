...
btnSearch.addEventListener('click',function(){
  ...
  drivingRecordsList.innerHTML = ''
   ...
   let url = "http://localhost:8080/api/driving-records/" + drivingLicenseNumber
   ...
   .then(drivingRecords => {
      ...
      drivingRecords.map(record => {
          ...
          noOfVoilationsLabel.innerHTML = "No Of Violations: " + record.noOfVoilations.toString()
          voilationTypeLabel.innerHTML = "Violation Type: " + record.violationType
